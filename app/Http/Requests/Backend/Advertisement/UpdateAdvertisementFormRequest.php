...
class UpdateAdvertisementFormRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'url_map.required' => 'رابط الخريطة مطلوب',
            'url_map.url' => 'رابط الخريطة يجب ان يكون رابط',
            ...
            'images.*.image' => 'الصور يجب ان تكون صورة',
            'images.*.mimes' => 'الصور يجب ان تكون من نوع jpeg,png,jpg,gif,svg',
            'images.*.max' => 'الصور يجب ان لا تزيد عن 2048 كيلو بايت',
