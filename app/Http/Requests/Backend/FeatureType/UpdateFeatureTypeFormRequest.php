...
class UpdateFeatureTypeFormRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name_en' => 'required|unique:feature_types,name_en,' . $this->id,
            'name_ar' => 'required|unique:feature_types,name_ar,' . $this->id,
            'status' => 'required',
        ];
    }
