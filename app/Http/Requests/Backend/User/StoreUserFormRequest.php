...
class StoreUserFormRequest extends FormRequest
{
    ...
    {
        if ($this->user_type == 1) {
            // if($this->phone == $this->office_phone)
            return [
                'name' => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'expire_date.required' => ' تاريخ انتهاء الرخصة مطلوب !!!',
            'expire_date.date' => ' تاريخ انتهاء الرخصة يجب ان يكون تاريخ !!!',
            'expire_date.after_or_equal' => ' تاريخ انتهاء الرخصة يجب ان يكون اكبر من او يساوي تاريخ اليوم !!!',
