...
class RealEstateOwnerController extends Controller
{
    ...
    public function userDashboard(Route $route)
    {
        try {
            ...
            return view('frontend.real_estate_owner.userDashboard', compact('user'));
        } catch (\Throwable $th) {
    ...
    {
        try {
            return view('frontend.real_estate_owner.changeRealEstateOfficeInfo');
        } catch (\Throwable $th) {
            $function_name =  $route->getActionName();
            $check_old_errors = new SupportTicket();
            $check_old_errors = $check_old_errors->select('*')->where([
    ...
    public function editUserDashboard(Route $route, $id)
    {
        try {
            ...
            return view('frontend.real_estate_owner.editUserDashboard', compact('user_cities'));
        } catch (\Throwable $th) {
            $function_name =  $route->getActionName();
            $check_old_errors = new SupportTicket();
            $check_old_errors = $check_old_errors->select('*')->where([
    ...
    public function updateUserDashboard(Route $route, UpdateRealEstateOfficeEndFormRequest $request, $id)
    {
        try {
            ...
            if ($user) {
                ...
                return redirect()->route('owner-userDashboard')->with('success', @trans('front.ChangeDoneSuccessfully'));
            }
    ...
    public function myAdvertisements(Route $route, Request $request)
    {
        try {
            ...
            return view('frontend.real_estate_owner.myAds', compact('myAds', 'targets', 'user_cities'));
        } catch (\Throwable $th) {
            $function_name =  $route->getActionName();
            $check_old_errors = new SupportTicket();
            $check_old_errors = $check_old_errors->select('*')->where([
    ...
    public function myFavAds(Route $route, Request $request)
    {
        try {
            ...
            return view('frontend.real_estate_owner.my_fav_ads', compact('my_fav_ads', 'targets'));
        } catch (\Throwable $th) {
            $function_name =  $route->getActionName();
            $check_old_errors = new SupportTicket();
            $check_old_errors = $check_old_errors->select('*')->where([
    ...
    public function addAdvertisements(Route $route)
    {
        try {
            ...
            if ($user_premium) {
                ...
                return view('frontend.real_estate_owner.addAdvertisements', compact('targets', 'construction_ages', 'land_areas', 'real_estate_statuses', 'number_of_rooms', 'number_of_bathrooms'));
            } else {
                return redirect()->route('owner-myPremiumMembership', auth()->guard('user')->user()->id)->with('danger', @trans('front.YouHaveToBuyPremiumMembership'));
            }
        } catch (\Throwable $th) {
            $function_name =  $route->getActionName();
            $check_old_errors = new SupportTicket();
        ...
        try {
            ...
            if ($user_premium) {
                $input_data = [
                    ...
                    'contact_method' => $request->contact_method ? $request->contact_method : null,
                ];
                ...
                return redirect()->route('owner-myAdvertisements')->with('success', @trans('front.AdHaveBeenAddedSuccessfully'));
            } else {
                return redirect()->route('owner-userDashboard')->with('danger', @trans('front.YouHaveToBuyPremiumMembership'));
            }
        } catch (\Throwable $th) {
            $function_name =  $route->getActionName();
            $check_old_errors = new SupportTicket();
    ...
    public function editAdvertisement(Route $route, $id)
    {
        try {
            ...
            if ($ad->edit_balance == 0 && $ad->expiry_date > now()) {
                return redirect()->route('owner-myAdvertisements')->with('danger', @trans('front.YouHaveExceededTheEditedTimes'));
                ...
                if (!$user_premium) {
                    return redirect()->back()->with('danger', 'يجب عليك شراء عضوية مميزة');
                }
            }
            $targets = Target::where('status', 1)->get();
            ...
            $number_of_rooms = Feature::where('status', 1)->where('feature_type_id', 4)->get();
            $number_of_bathrooms = Feature::where('status', 1)->where('feature_type_id', 5)->get();
            return view('frontend.real_estate_owner.editAdvertisements', compact('targets', 'user_cities', 'construction_ages', 'land_areas', 'real_estate_statuses', 'number_of_rooms', 'number_of_bathrooms', 'ad'));
        } catch (\Throwable $th) {
            $function_name =  $route->getActionName();
            $check_old_errors = new SupportTicket();
            $check_old_errors = $check_old_errors->select('*')->where([
        ...
        try {
            ...
            if ($advertisement) {
                ...
                if ($advertisement->expiry_date > date('Y-m-d H:i:s')) {
                    ...
                    return redirect()->route('owner-myAdvertisements')->with('success', @trans('front.TheAdHaveBeenEdited'));
                }
                //======================================================================
                //===================================repost=============================
                //======================================================================
                ...
                return redirect()->route('owner-userDashboard')->with('success', @trans('front.RePublishRequestHasBeenSent'));
            } else {
    ...
    public function myAdvertisementDetails(Route $route, $id)
    {
        try {
            ...
            if ($advertisement) {
                ...
                return view('frontend.real_estate_owner.myAdvertisementDetails', compact('advertisement'));
            } else {
                return redirect()->back()->with('danger', @trans('front.AdDoesNotExist'));
            }
        } catch (\Throwable $th) {
    ...
    public function myPremiumMembership(Route $route)
    {
        try {
            ...
            return view('frontend.real_estate_owner.myPremiumMembership', compact('premium_memberships', 'user_premium_memberships'));
        } catch (\Throwable $th) {
            $function_name =  $route->getActionName();
            $check_old_errors = new SupportTicket();
            $check_old_errors = $check_old_errors->select('*')->where([
    ...
    public function deleteAdvertisement($id, Route $route)
    {
        try {
            ...
            if ($advertisement) {
                ...
                return redirect()->route('owner-myAdvertisements')->with('success', @trans('front.AdHaveBeenDeleted'));
            } else {
                return redirect()->back()->with('danger', @trans('front.AdHaveNotBeenFound'));
            }
        } catch (\Throwable $th) {
    ...
    public function enquiryDetails(Route $route, $id)
    {
        try {
            ...
            if ($enquery) {
                return view('frontend.real_estate_owner.enquiry_details', compact('enquery'));
            } else {
    ...
    public function viewEnquiry(Route $route)
    {
        try {
            ...
            return view('frontend.real_estate_owner.view_enquiry', compact('advertisements'));
        } catch (\Throwable $th) {
            $function_name =  $route->getActionName();
            $check_old_errors = new SupportTicket();
            $check_old_errors = $check_old_errors->select('*')->where([
    ...
    public function destroyEnquiry(Route $route, $id)
    {
        try {
            ...
            if ($enquery_request) {
                ...
                return redirect()->route('owner-viewEnquiry')->with('success', @trans('front.InquiryHaveBeenDeleted'));
            } else {
                return redirect()->back()->with('danger', @trans('front.InquiryDoesNotExist'));
            }
        } catch (\Throwable $th) {
    ...
    {
        try {
            $offers = CustomerRequestAndOffer::where('user_id', '=', auth()->guard('user')->user()->id)->get();
            return view('frontend.real_estate_owner.customer_requests_offers', compact('offers'));
        } catch (\Throwable $th) {
            $function_name =  $route->getActionName();
            $check_old_errors = new SupportTicket();
            $check_old_errors = $check_old_errors->select('*')->where([
    ...
    public function createCustomerRequestsOffer(Route $route,)
    {
        try {
            ...
            return view('frontend.real_estate_owner.create_customer_requests_offers', compact('targets'));
        } catch (\Throwable $th) {
            $function_name =  $route->getActionName();
            $check_old_errors = new SupportTicket();
            $check_old_errors = $check_old_errors->select('*')->where([
    ...
    public function storeCustomerRequestsOffer(Route $route, StoreCustomerRequestsOfferFormRequest $request)
    {
        try {
            ...
            return redirect()->route('owner-customerRequestsOffers')->with('success', @trans('front.AddedSuccessfully'));
        } catch (\Throwable $th) {
            $function_name =  $route->getActionName();
            $check_old_errors = new SupportTicket();
            $check_old_errors = $check_old_errors->select('*')->where([
    ...
    public function showCustomerRequestsOffer(Route $route, $id)
    {
        try {
            ...
            if ($offer) {
                // return $offer;
                return view('frontend.real_estate_owner.show_customer_requests_offer', compact('offer'));
            } else {
                return redirect()->route('owner-customerRequestsOffers')->with('error', @trans('front.ThisOfferDoesNotExist'));
            }
        } catch (\Throwable $th) {
            $function_name =  $route->getActionName();
            $check_old_errors = new SupportTicket();
    ...
    public function sendEnquiryReplay(Route $route, $id, ReplayEnqueryRequestFormRequest $request)
    {
        try {
            ...
            if ($replay) {
                ...
                return redirect()->route('owner-viewEnquiry')->with('success', @trans('front.ReplySent'));
            } else {
                return redirect()->route('owner-viewEnquiry')->with('danger', @trans('front.InquiryDoesNotExist'));
            }
        } catch (\Throwable $th) {
            $function_name =  $route->getActionName();
            $check_old_errors = new SupportTicket();
