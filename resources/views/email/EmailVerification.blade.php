                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="450" id="templateHeader"
                                    ...
                                    <tr>
                                        <td class="headerContent centeredWithBackground"
                                            style="border-collapse:collapse;color:#202020;font-family:Arial;font-size:34px;font-weight:bold;line-height:100%;padding:0;text-align:center;vertical-align:middle;background-color:#42618A;padding-bottom:20px;padding-top:20px;">
                                            <!-- // Begin Module: Standard Header Image \\ -->
                                            <img width="130"
                                                src="https://diyarnaa.com/style_files/frontend/img/logo.png"
                                                ...
                                                <tr>
                                                    <td valign="top"
                                                        ...
                                                        <div
                                                            ...
                                                            @if ($type == 'Accept')
                                                            <h1 class="h1"
                                                            style="color:#202020;display:block;font-family:Arial;font-size:24px;font-weight:bold;line-height:100%;margin-top:20px;margin-right:0;margin-bottom:20px;margin-left:0;text-align:center;"> تم الموافقه على تسجيل حسابك </h1>  
                                                            @endif
                                                            ...
                                                            <h1 class="h1"
                                                                ...
                                                                قم بتأكيد بريدك الألكتروني</h1>

                                                    
                                                            <p>الرجاء النقر فوق الزر أدناه للتحقق من بريدك الإلكتروني.</p>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                            ...
                                                            <tbody>
                                                                <tr align="center">
                                                                    <td align="center" valign="middle"
                                                                        ...
                                                                        <a class="buttonText"
                                                                            href="{{ route('EmailVerify',['verify_id'=>$verify_id ,'type'=>$type ] ) }}"
                                                                            target="_blank"
                                                                            style="color: #4A90E2;text-decoration: none;font-weight: normal;display: block;border: 2px solid #585858;padding: 10px 80px;font-family: Arial;">تاكيد</a>
                                    ...
                                    <tr>
                                        <td valign="top" class="footerContent"
                                            ...
                                            <div
                                                ...
                                                <p style="text-align:left;margin:0;margin-top:2px;">design and
                                                    development BlueRay Software Solutions Company. © All rights
                                                    reserved 2023</p>
                                            </div>
                                            <!-- // End Module: Standard Footer \\ -->
                                        </td>
