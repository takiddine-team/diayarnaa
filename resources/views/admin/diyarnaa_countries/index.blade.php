...
@section('content')
                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <i class="fas fa-users-cog"></i> جميع الدول
                            </li>
                        </ol>
                    </nav>
                </div>
                <div>
                    <a href="{{ route('super_admin.diyarnaa_countries-create') }}" class="mb-1 btn btn-primary"><i
                            class="mdi mdi-playlist-plus"></i>اضافة  </a>
                    <a href="{{ route('super_admin.diyarnaa_countries-showSoftDelete') }}" class="mb-1 btn btn-danger"><i
                    ...
                    <table id="hoverable-data-table" class="table table-hover table-striped">
                        ...
                        <tbody>
                            @if (isset($diyarnaa_countries) && $diyarnaa_countries->count() > 0)
                                @foreach ($diyarnaa_countries as $country)
                                    <tr>
  ...
  <td style="text-align: center">{!! isset($country->country_code)
                                        ...
                                        <td style="text-align: center">
                                            {!! isset($country->currency->name_en) ? $country->currency->name_en : "<span style='color:red;'>Undefined</span>" !!}
                                        </td>
                                        <td style="text-align: center">
                                             <a href="{{ route('super_admin.diyarnaa_countries-showCities', [isset($country->id) ? $country->id : '----------']) }}"
                                                class=" mb-1 btn btn-sm btn-success" title="show">المحافظات </a>
                                            <a href="{{ route('super_admin.diyarnaa_countries-edit', isset($country->id) ? $country->id : -1) }}"
                                                class="mb-1 btn btn-sm btn-success"><i
                                                    class="mdi mdi-playlist-edit"></i></a>
                                            <a href="{{ route('super_admin.diyarnaa_countries-softDelete', [isset($country->id) ? $country->id : '----------']) }}"
                                                class="confirm mb-1 btn btn-sm btn-danger" title="Delete"><i
                                                    class="mdi mdi-delete"></i></a>
                                            <a href="{{ route('super_admin.diyarnaa_countries-activeInactiveSingle', [isset($country->id) ? $country->id : '----------']) }}"
