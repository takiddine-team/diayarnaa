                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <i class="fas fa-users-cog"></i>جميع التصنيفات
                            </li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <tbody>
                            @if (isset($categories) && $categories->count() > 0)
                                @foreach ($categories as $category)
                                    <tr>
                                        <td style="text-align: center">{!! isset($category->name_en)
                                            ? $category->name_en
                                            : "<span style='color:blue;'>----------</span>" !!} </td>
                                        <td style="text-align: center">{!! isset($category->name_ar)
                                            ? $category->name_ar
                                            : "<span style='color:blue;'>----------</span>" !!} </td>
                                        ...
                                        <td style="text-align: center">
                                           <a href="{{ route('super_admin.categories-edit', isset($category->id) ? $category->id : -1) }}"
                                            ...
                                            <a href="{{ route('super_admin.categories-activeInactiveSingle', [isset($category->id) ? $category->id : '----------']) }}"
