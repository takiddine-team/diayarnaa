    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                <div>
                    <a href="{{ route('super_admin.targets-create') }}" class="mb-1 btn btn-primary"><i
                            class="mdi mdi-playlist-plus"></i>اضافة  </a>
                    <a href="{{ route('super_admin.targets-showSoftDelete') }}" class="mb-1 btn btn-danger"><i
                            ...
                            @if (isset($targets) && $targets->count() > 0)
                                @foreach ($targets as $target)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <a href="{{ route('super_admin.targets-edit', isset($target->id) ? $target->id : -1) }}"
                                                class="mb-1 btn btn-sm btn-success"><i
                                                    class="mdi mdi-playlist-edit"></i></a>
                                            <a href="{{ route('super_admin.targets-softDelete', [isset($target->id) ? $target->id : '----------']) }}"
                                                class="confirm mb-1 btn btn-sm btn-danger" title="Delete"><i
                                                    class="mdi mdi-delete"></i></a>
                                            <a href="{{ route('super_admin.targets-activeInactiveSingle', [isset($target->id) ? $target->id : '----------']) }}"
