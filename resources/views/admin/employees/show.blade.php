...
@section('content')
    ...
    <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                <ol class="breadcrumb p-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('super_admin.employees-index') }}">
                            <i class="mdi mdi-format-list-bulleted"></i> الموظفين
                        </a>
                    </li>
        ...
        <div>
            <a href="{{ route('super_admin.employees-edit', [isset($user->id) ? $user->id : 'Undefined']) }}"
                class="mb-1 btn btn-primary" title="Edit"><i class="mdi mdi-playlist-edit"></i></i> تعديل </a>

            @if (isset($user->status) && $user->status == 'Pending')
                <a href="{{ route('super_admin.employees-reject', [isset($user->id) ? $user->id : -1]) }}"
                    class=" mb-1 btn btn-danger" title=" Reject"><i class="fas fa-ban"></i> رفض </a>
                <a href="{{ route('super_admin.employees-accept', [isset($user->id) ? $user->id : -1]) }}"
