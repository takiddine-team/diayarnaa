        ...
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    ...
                    <h1><i class="mdi mdi-delete"></i> ارشيف   التصنيفات الفرعية</h1>
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.sub_categories-index') }}">
                                    <i class="mdi  mdi-home"></i>   التصنيفات الفرعية
                                </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page"><i class="mdi mdi-delete"></i>ارشيف المستخدمين
                            </li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <tbody>
                            @if (isset($subCategories) && $subCategories->count() > 0)
                                @foreach ($subCategories as $subCategory)
                                    <tr>
                                        <td style="text-align: center">{!! isset($subCategory->name_en)
                                            ? $subCategory->name_en
                                            : "<span style='color:blue;'>----------</span>" !!} </td>
                                        <td style="text-align: center">{!! isset($subCategory->name_ar)
                                            ? $subCategory->name_ar
                                            : "<span style='color:blue;'>----------</span>" !!} </td>
                                        ...
                                        <td>
                                            <a href="{{ route('super_admin.sub_categories-softDeleteRestore', [isset($subCategory->id) ? $subCategory->id : '----------']) }}"
