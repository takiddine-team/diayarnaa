    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    <h1><i class="mdi mdi-delete"></i> ارشيف الابحاث المضافة</h1>
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.searches-index') }}">
                                    <i class="mdi  mdi-home"></i> الابحاث المضافة
                                </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page"><i class="mdi mdi-delete"></i> أرشيف الابحاث المضافة
                            </li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <table id="hoverable-data-table" class="table table-hover table-striped">
                        ...
                        <tbody>
                            @if (isset($searches) && $searches->count() > 0)
                                @foreach ($searches as $advertisement)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('super_admin.searches-softDeleteRestore', [isset($advertisement->id) ? $advertisement->id : '----------']) }}"
