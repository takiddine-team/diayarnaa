                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <form id="createForm"
                                            action="{{ route('super_admin.terms_conditions-update', $term->id) }}"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="term_title_ar"
                                                            ...
                                                            value="{!! $term->term_title_ar ? $term->term_title_ar : null !!}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="term_title_en"
                                                            ...
                                                            value="{!! $term->term_title_en ? $term->term_title_en : null !!}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select name="status"
                                                            ...
                                                            <option value="1"
                                                                @if ($term->status == 'Active') selected @endif>نشط
                                                            </option>
                                                            <option value="2"
                                                                @if ($term->status == 'Inactive') selected @endif>
                                                                غير نشط
                                                            </option>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea style="width: 90% !important" name="term_description_ar" maxlength="1600" class="form-control ckeditor"
                                                            rows="20">{{ isset($term->term_description_ar) ? $term->term_description_ar : null }}</textarea>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea style="width: 90% !important" name="term_description_en" maxlength="1600" class="form-control ckeditor"
                                                            rows="20">{{ isset($term->term_description_en) ? $term->term_description_en : null }}</textarea>
