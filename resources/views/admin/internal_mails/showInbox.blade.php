...
@section('content')
    ...
    <div class="breadcrumb-wrapper breadcrumb-contacts">
        <div>
            <h1><i class="mdi mdi-information"></i> البريد الوارد</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb p-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('super_admin.internal_mails-inbox') }}">
                            <i class="mdi mdi-format-list-bulleted"></i> البريد الوارد
                        </a>
                    </li>
        ...
        <div>
            ...
            <a href="{{ route('super_admin.internal_mails-sendEmail', ['email'=>isset($mail->userSender->email) ? $mail->userSender->email : null]) }}"
                class="mb-1 btn btn-primary" title="Edit"><i class="mdi mdi-playlist-edit"></i></i> رد </a>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th>الاسم : <span style="color:blue;">
                                                            {!! isset($mail->userSender->name) ? $mail->userSender->name : '<span style="color:blue;">----------</span>' !!}
                                                        </span> </th>
                                                    <th>
                                                        الايميل : <span style="color:blue;">
                                                            {!! isset($mail->userSender->email) ? $mail->userSender->email : '<span style="color:blue;">----------</span>' !!}
                                                        </span>
                                                    </th>
                                                    <th>
