                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item" aria-current="page">   ارسال بريد داخلي  </li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <form id="createForm"
                                            action="{{ route('super_admin.internal_mails-sendEmailRequest', isset($mail->id) ? $mail->id : -1) }}"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6 mb-3" id="office">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email"  @if (old('email')) value="{{ old('email') }}" @else value="{{ Request('email') }}" @endif
