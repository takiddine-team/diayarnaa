                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.features-index') }}">
                                    <i class="fas fa-users-cog"></i> List Features
                                </a>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <form id="createForm"
                                            action="{{ route('super_admin.features-update', isset($feature->id) ? $feature->id : -1) }}"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="name_ar"
                                                            ...
                                                            value="{!! $feature->name_ar ? $feature->name_ar : null !!}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="name_en"
                                                            ...
                                                            value="{!! $feature->name_en ? $feature->name_en : null !!}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="feature_type_id" id="feature_type_id"
                                                            ...
                                                            <option value="" selected>اختر نوع ميزة  ...
                                                            </option>
                                                            @if (isset($feature_types) && $feature_types->count() > 0)
                                                                @foreach ($feature_types as $feature_type)
                                                                    ...
                                                                    @else
                                                                        @if ($feature->feature_type_id == $feature_type->id) selected @endif
                                                                        @endif>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select name="status"
                                                            ...
                                                            <option value="1"
                                                                @if ($feature->status == 'Active') selected @endif>مفعل
                                                            </option>
                                                            <option value="2"
                                                                @if ($feature->status == 'Inactive') selected @endif>غير مفعل
                                                            </option>
