                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <i class="fas fa-users-cog"></i>جميع الميزات 
                            </li>
                        </ol>
                    </nav>
                </div>
                <div>
                    <a href="{{ route('super_admin.features-create') }}" class="mb-1 btn btn-primary"><i
                            class="mdi mdi-playlist-plus"></i>اضافة  </a>
                    <a href="{{ route('super_admin.features-showSoftDelete') }}" class="mb-1 btn btn-danger"><i
                    ...
                    <table id="hoverable-data-table" class="table table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center"><i class="mdi mdi-format-title"></i> نوع الميزة </th>
                            ...
                            @if (isset($features) && $features->count() > 0)
                                @foreach ($features as $feature)
                                    <tr>
                                        ...
                                        <td style="text-align: center">{!! isset($feature->featureType->name_ar) ? $feature->featureType->name_ar : "<span style='color:blue;'>----------</span>" !!} </td>
                                        ...
                                        <td style="text-align: center">
                                            <a href="{{ route('super_admin.features-edit', isset($feature->id) ? $feature->id : -1) }}"
                                                class="mb-1 btn btn-sm btn-success"><i
                                                    class="mdi mdi-playlist-edit"></i></a>
                                            <a href="{{ route('super_admin.features-softDelete', isset($feature->id) ? $feature->id : -1) }}"
                                                class="confirm mb-1 btn btn-sm btn-danger"><i
                                                    class="mdi mdi-delete"></i></a>
                                            <a href="{{ route('super_admin.features-activeInactiveSingle', [isset($feature->id) ? $feature->id : '----------']) }}"
