                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.feature_types-index') }}">
                                    <span class="fa fa-th"></span> أنواع الميزات
                                </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">اضافة نوع ميزة </li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <form id="createForm" action="{{ route('super_admin.feature_types-store') }}"
