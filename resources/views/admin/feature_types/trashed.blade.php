                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.feature_types-index') }}">
                                    <i class="mdi  mdi-home"></i> جميع انواع الميزات
                                </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page"><i class="mdi mdi-delete"></i> 
                                الارشيف
                    ...
                    <table id="hoverable-data-table" class="table table-hover table-striped">
                        ...
                        <tbody>
                            @if (isset($feature_types) && $feature_types->count() > 0)
                                @foreach ($feature_types as $index => $feature)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('super_admin.feature_types-softDeleteRestore', [isset($feature->id) ? $feature->id : '----------']) }}"
