    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    <h1>ربط التصنيفات الفرعية بأنواع الميزات </h1>
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.feature_type_sub_categories-index') }}">
                                    <span class="fa fa-th"></span> ربط التصنيفات الفرعية بأنواع الميزات
                                </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">اضافة ربط التصنيفات الفرعية بأنواع الميزات </li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <form id="createForm"
                                            action="{{ route('super_admin.feature_type_sub_categories-store') }}"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12 mb-2">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li style="display: inline-block; width: 15%;  list-style: outside none none;  ">
                                                            <input class="single-checkbox " type="checkbox"
                                                            name="feature_type_ids[]"
                                                            value="{{ $feature_type->id }}"
                                                            id="feature_type{{ $key + 1 }}">
