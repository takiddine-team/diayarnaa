    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    <h1><i class="mdi mdi-delete"></i> أرشيف العضويات المميزة</h1>
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.premiumMemberships-index') }}">
                                    <i class="mdi  mdi-home"></i>  العضويات المميزة
                                </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page"><i class="mdi mdi-delete"></i> أرشيف العضويات المميزة
                            </li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <table id="hoverable-data-table" class="table table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center"><i class="mdi mdi-format-title"></i> السعر</th>
                                <th style="text-align: center"><i class="mdi mdi-format-title"></i> صلاحية الاعلان</th>
                                <th style="text-align: center"><i class="mdi mdi-format-title"></i> صلاحية العضوية
                                </th>
                                <th style="text-align: center"><i class="mdi mdi-format-title"></i> عدد الاعلانات</th>
                            ...
                            @if (isset($memberships) && $memberships->count() > 0)
                                @foreach ($memberships as $index => $membership)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('super_admin.premiumMemberships-softDeleteRestore', [isset($membership->id) ? $membership->id : '----------']) }}"
