    ...
    <div class="innerPage">
        ...
        <div class="page_wrapper dashboard">
            <div class="bredCramb">
                ...
                >> <span> @lang('front.PersonalInformation') </span>
            </div>
                                ...
                                <div class="Text">
                                    ...
                                    <span class="inside">
                                        <img src="{{ asset('style_files/frontend/img/calendar.png') }}" class="img-fluid"
                                            alt="img">
                                        <span>
                                            @lang('front.RegistrationDate') :
                                            {{ isset($user->created_at) ? $user->created_at->format('Y/m/d') : null }}
                                        </span>
                                    </span>
                                </div>
                                <a href="{{ route('office-editUserDashboard', isset($user->id) ? $user->id : -1) }}">
                        ...
                        <div class="col-12 tBorder mt-5">
                            <div class="bShadow">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="image">
                                            <img src="{{ asset('style_files/frontend/img/phone-call.png') }}"
                                                class="img-fluid" alt="img">
                                        </div>
                                        <span class="text">
                                            @lang('front.Phone') :
                                            <span>{{ isset($user->office_phone) ? $user->office_phone : null }}</span>
                                        </span>
                                    </li>
                                    <li>
                                        <div class="image">
                                ...
                                <div class="aboutOffice">
                                    <h2>@lang('front.AboutOffice')</h2>
                                    <p>{!! isset($user->additional_information) ? $user->additional_information : null !!}
                                    </p>
                                </div>
                            </div>
                        </div>
