                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 bShadow">
                            <form action="{{ route('office-storeCustomerRequestsOffer') }}" class="editUserForm"
                                method="POST" id="createForm" enctype="multipart/form-data">
                                @csrf
                                <h2>@lang('front.CustomerRequestsAndOffers')</h2>
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" onchange="getDiyarnaaCities()" name="target_id">
                                                @if (isset($targets) && $targets->count() > 0)
                                                    <option value="" selected> @lang('front.SelectPurpose') </option>
                                                    @foreach ($targets as $target)
                                                        ...
                                                        @else @if ($target->target_id == $target->id) selected @endif
                                                            ...
                                                            @if (Config::get('app.locale') == 'ar')
                                                                <span>
                                                                    {{ isset($target->name_ar) ? $target->name_ar : null }}</span>
                                                            @elseif (Config::get('app.locale') == 'en')
                                                                <span>{{ isset($target->name_en) ? $target->name_en : null }}</span>
                                                            @endif
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            </label> <select name="diyarnaa_city_id" id="diyarnaa_city_id"
                                   ...
                                   <div class="col-md-6">
                                    ...
                                    <div class="col-md-6 mb-4" id="video_div">
                                        <label class="text-dark font-weight-medium mb-3" for="video">
                                            <span class="d-block">فيديو :</span>
                                            <span class="text-danger d-block">(mp4,ogx,oga,ogv,ogg,webm) ( Max-Size
                                                :
                                                20MB
                                                )
                                            </span>
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="submit" class="submit" value="@lang('front.Ad')">
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == true) {
                        ...
                        var selectCity = '<option value=""> @lang('front.City')... </option>';
