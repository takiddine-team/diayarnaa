                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 bShadow">
                            <form
                                action="{{ route('office-updateUserDashboard', isset(Auth::guard('user')->user()->id) ? Auth::guard('user')->user()->id : -1) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3" id="office_phone">
                                        ...
                                        <input type="tel" class="form-control" id="office_phone" name="office_phone"
                                            value="@if (old('office_phone')) {{ old('office_phone') }}@else {{ isset(Auth::guard('user')->user()->office_phone) ? Auth::guard('user')->user()->office_phone : '' }} @endif">
                                    </div>
                                    {{-- mobile --}}
                                    <div class="col-md-6 mb-3">
