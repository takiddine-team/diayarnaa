    ...
    <div class="innerPage">
        ...
        <div class="page_wrapper dashboard">
            <div class="bredCramb">
                ...
                >> <span>@lang('front.EstateOffice')</span>
            </div>
                        ...
                        <div class="allLeft">
                                            ...
                                            <ul id="imageGallery">
                                                @foreach ($advertisement->advertisementImage as $advertisement_image)
                                                    @if (isset($advertisement_image->image) &&
                                                        ...
                                                        <li data-thumb="{{ asset($advertisement_image->image) }}"
                                                            data-src="{{ asset($advertisement_image->image) }}">
                            ...
                            <div class="footerLinksState">
                                @if (isset($advertisement->expiry_date) &&
                                    ...
                                    <a href="{{ route('office-editAdvertisement', isset($advertisement->id) ? $advertisement->id : -1) }}"
                                        class="mainBg btn">
                                        اعادة نشر
                                    </a>
                                @endif
                                @if (isset($advertisement->edit_balance) &&
                                        ...
                                        $advertisement->status != 'Pending')
                                    <a
                                        href="{{ route('office-editAdvertisement', isset($advertisement->id) ? $advertisement->id : -1) }}">
                                        @lang('front.Edit') </a>
                                @elseif($advertisement->advertisementEditRequests->count() == 0)
                                    @if ($advertisement->status != 'Pending' && $advertisement->expiry_date > date('Y-m-d H:i:s'))
                                        <a
                                            href="{{ route('office-advertisementEditRequest', isset($advertisement->id) ? $advertisement->id : -1) }}">
                                            طلب تعديل
                                        </a>
                                    @endif
                                @endif
                                @if (isset($advertisement->status) && ($advertisement->status == 'Active' || $advertisement->status == 'Inactive'))
                                    <a
                                        href="{{ route('office-activeInactiveAdvertisement', isset($advertisement->id) ? $advertisement->id : -1) }}">
                                ...
                                @endif
                                <a
                                    href="{{ route('office-deleteAdvertisement', isset($advertisement->id) ? $advertisement->id : -1) }}">
                                    @lang('front.Delete')</a>
                            </div>
