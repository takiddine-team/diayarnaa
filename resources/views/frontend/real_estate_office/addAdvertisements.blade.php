                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 bShadow">
                            <form class="editUserForm noflex" class="realStateFilter " id="createForm"
                                style="text-align: initial" action="{{ route('office-addAdvertisementsRequest') }}"
                                ...
                                <div class="row">
                                            ...
                                            @if (isset($construction_ages) && $construction_ages->count() > 0)
                                                @foreach ($construction_ages as $construction_age)
                                                    <option value="{{ $construction_age->id }}"
                                                        @if (old('construction_age') == $construction_age->id) selected @endif>

                                                        @if (old('construction_age') == $construction_age->id)
                                                            selected
                                                        @endif>
                                                        ...
                                                        @if (Config::get('app.locale') == 'ar')
                                                            {{ isset($construction_age->name_ar) ? $construction_age->name_ar : '------' }}
                                                        @elseif (Config::get('app.locale') == 'en')
                                                            {{ isset($construction_age->name_en) ? $construction_age->name_en : '------' }}
                                                        @endif
                                                    </option>
                                                @endforeach
                                            @endif
                                            ...
                                            @if (isset($land_areas) && $land_areas->count() > 0)
                                                @foreach ($land_areas as $land_area)
                                                    <option value="{{ $land_area->id }}"
                                                        @if (old('land_area') == $land_area->id) selected @endif>

                                                        {{--  {{ isset($land_area->name_ar) ? $land_area->name_ar : '------' }}  --}}
                                                        @if (Config::get('app.locale') == 'ar')
                                                            {{ isset($land_area->name_ar) ? $land_area->name_ar : '------' }}
                                                        @elseif (Config::get('app.locale') == 'en')
                                                            {{ isset($land_area->name_en) ? $land_area->name_en : '------' }}
                                                        @endif
                                            ...
                                            @if (isset($real_estate_statuses) && $real_estate_statuses->count() > 0)
                                                @foreach ($real_estate_statuses as $real_estate_status)
                                                    <option value="{{ $real_estate_status->id }}"
                                                        @if (old('real_estate_status') == $real_estate_status->id) selected @endif>

                                                        {{--  {{ isset($real_estate_status->name_ar) ? $real_estate_status->name_ar : '------' }}  --}}
                                                        @if (Config::get('app.locale') == 'ar')
                                                            {{ isset($real_estate_status->name_ar) ? $real_estate_status->name_ar : '------' }}
                                                        @elseif (Config::get('app.locale') == 'en')
                                                            {{ isset($real_estate_status->name_en) ? $real_estate_status->name_en : '------' }}
                                                        @endif
                                            ...
                                            @if (isset($number_of_rooms) && $number_of_rooms->count() > 0)
                                                @foreach ($number_of_rooms as $number_of_room)
                                                    <option value="{{ $number_of_room->id }}"
                                                        @if (old('number_of_rooms') == $number_of_room->id) selected @endif>

                                                        {{--  {{ isset($number_of_room->name_ar) ? $number_of_room->name_ar : '------' }}  --}}
                                                        @if (Config::get('app.locale') == 'ar')
                                                            {{ isset($number_of_room->name_ar) ? $number_of_room->name_ar : '------' }}
                                                        @elseif (Config::get('app.locale') == 'en')
                                                            {{ isset($number_of_room->name_en) ? $number_of_room->name_en : '------' }}
                                                        @endif
                                            ...
                                            @if (isset($number_of_bathrooms) && $number_of_bathrooms->count() > 0)
                                                @foreach ($number_of_bathrooms as $number_of_bathroom)
                                                    <option value="{{ $number_of_bathroom->id }}"
                                                        @if (old('number_of_bathrooms') == $number_of_bathroom->id) selected @endif>
                                                        ...
                                                        @if (Config::get('app.locale') == 'ar')
                                                            {{ isset($number_of_bathroom->name_ar) ? $number_of_bathroom->name_ar : '------' }}
                                                        @elseif (Config::get('app.locale') == 'en')
                                                            {{ isset($number_of_bathroom->name_en) ? $number_of_bathroom->name_en : '------' }}
                                                        @endif
                                                ...
                                                @if (isset($user_cities) && count($user_cities) > 0)
                                                    @foreach ($user_cities as $city)
                                                        <option value="{{ $city->id }}"
                                                            @if (old('diyarnaa_city_id') == $city->id) selected @endif>
                                                            @if (Config::get('app.locale') == 'ar')
                                                                <span class="realState_Location">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="number" min="0" class="form-control" id="price"
                                            name="price" value="{!! old('price') ? old('price') : null !!}">
                                    </div>
                                                ...
                                                @foreach ($land_areas as $area_type)
                                                    <option value="{{ $area_type->id }}"
                                                        ...
                                                        @if (Config::get('app.locale') == 'ar')
                                                            {{ isset($area_type->name_ar) ? $area_type->name_ar : '------' }}
                                                        @elseif (Config::get('app.locale') == 'en')
                                                            {{ isset($area_type->name_en) ? $area_type->name_en : '------' }}
                                                        @endif
                                                    </option>
                                                @endforeach
                                            @endif
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="number" min="0" class="form-control" id="area"
                                            name="area" value="{!! old('area') ? old('area') : null !!}">
                                    </div>

                                    {{-- اسم وكيل الاعلان --}}
                                    <div class="col-md-6 mb-4">
                                        <label for="real_estate_agent_name">
                                            @if (Config::get('app.locale') == 'ar')
                                                <span class="realState_Location">
                                                    اسم وكيل الاعلان </span>
                                            @elseif (Config::get('app.locale') == 'en')
                                                <span class="realState_Location">
                                            ...
                                            <strong class="text-danger">
                                                ...
                                                @error('real_estate_agent_name')
                                                    -
                                                    {{ $message }}
                                                @enderror
                                            </strong>
                                        </label>
                                        <input type="text" class="form-control" id="real_estate_agent_name"
                                            name="real_estate_agent_name" value="{!! old('real_estate_agent_name') ? old('real_estate_agent_name') : null !!}">
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <textarea name="address" id="address	" cols="30" rows="5" class="form-control">{{ old('address') ? old('address') : null }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-4 ">
                                        <label for="real_estate_formula">
                                            @if (Config::get('app.locale') == 'ar')
                                                <span class="realState_Location">
                                                    ...
                                                    الصيغة العقارية * (إجباري) ( يجب ألا تقل عن 100 حرف.) 
                                                </span>
                                            @elseif (Config::get('app.locale') == 'en')
                                                <span class="realState_Location">
                                                    Real Estate Formula * (Mandatory) (Must be less than 100 characters.)
                                                </span>
                                            @endif
                                            <strong class="text-danger">
                                        ...
                                        <textarea name="real_estate_formula" id="real_estate_formula" cols="30" rows="5" class="form-control">{{ old('real_estate_formula') ? old('real_estate_formula') : null }}</textarea>
                                    </div>
                                    ...
                                    {{-- مرجع الاعلان --}}
                                    <div class="col-md-6 mb-4">
                                        <label for="ad_reference">
                                            @if (Config::get('app.locale') == 'ar')
                                                <span class="realState_Location">
                                                    مرجع الاعلان <span class="text-danger">(كتابة رقم خاص بالإعلان حتى يتم
                                                        الرجوع إليه بسهولة)</span> </span>
                                            @elseif (Config::get('app.locale') == 'en')
                                                <span class="realState_Location">
                                                    Ad Reference </span>
                                            @endif
                                        ...
                                        <input type="text" class="form-control" name="ad_reference"
                                            value="{{ old('ad_reference') }}">
                                    </div>
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <button class="mdi btn btn-primary" type="button"
                                                onclick="allAreNull()"><span
                                                    class="mdi mdi-plus"></span>@lang('front.AddAd')</button>


                                            {{-- <input type="submit" class="submit" value="ارسل"> --}}
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        $(document).ready(function() {
            $("#add").click(function() {
                ...
                var fTypeTwo = $(
                    ...
                    "\"   type=\"text\" name=\"feature_ar[]\" style=\"margin-right: 0px\" class=\"fieldname form-control\" />"
                );
                var removeButton = $(
...
//========================================================================================= --}}
    <script>
        ...
        function getFeatureType() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('office-getFeatureType') }}",
                data: formData,
                processData: false,
                contentType: false,
                cache: false,
