...
@section('content')
    ...
    <div class="innerPage">
        ...
        <section class="innerImage aboutUs">
            ...
            <div class="pageTitle">
                <h2>@lang('front.InquiryRequest')</h2>
            </div>
        </section>
        ...
        <div class="page_wrapper dashboard">
            <div class="bredCramb">
                ...
                >> <span>@lang('front.InquiryRequest')</span>
            </div>
                                ...
                                @if (isset($advertisements) && count($advertisements) > 0)
                                    @foreach ($advertisements as $advertisement)
                                        <h6 class="ask_heading">@lang('front.YouHave')
                                            ...
                                            @lang('front.InquiryRequestAdCode'){{ $advertisement->code }}
                                        </h6>
                                        @foreach ($advertisement->enqueryRequests as $ask)
                                            <div class="ask-page lll">
                                                <div class="col-md-9 mb-3">
                                                    <label>{{ Str::limit($ask->message, 175) }}</label>
                                                </div>
                                                {{-- reply --}}
                                                <div class="col-md-3 m-3 askbtn">
                                                    <a
                                                        href="{{ route('office-enquiryDetails', isset($ask->id) ? $ask->id : -1) }}">@lang('front.View')</a>
                                                    <a class="confirm"
                                                        href="{{ route('office-destroyEnquiry', isset($ask->id) ? $ask->id : -1) }}">@lang('front.Delete')</a>
