    ...
    <div class="innerPage">
        ...
        <div class="page_wrapper dashboard">
            <div class="bredCramb">
                ...
                >> <span> @lang('front.MyAddedAds')</span>
            </div>
                ...
                <div class="container">
                    <div class="col-12">
                        <div class="allLeft">
                            <div class="row">
                                <div class="col-12">
                                    <form action="{{ route('office-myAdvertisements') }}" class="realStateFilter  signUp"
                                        ...
                                        <div class="col-lg-4 col-md-6 mb-3 ">
                                            <div class="realStateItem">
                                                ...
                                                <div class="top">
                                                    ...
                                                    <div class="text">
                                                        <a
                                                            href="{{ route('office-myAdvertisementDetails', isset($advertisment->id) ? $advertisment->id : -1) }}">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            @if (isset($advertisment->expiry_date) &&
                                                                ...
                                                                <a href="{{ route('office-editAdvertisement', isset($advertisment->id) ? $advertisment->id : -1) }}"
                                                                    class="mainBg btn">
                                                                    @lang('front.RePublish') </a>
                                                            @endif
                                                        </li>
                                                        ...
                                                        @elseif($advertisment->advertisementEditRequests->count() == 0)
                                                            @if (
                                                                $advertisment->status != 'Pending' &&
                                                                    ...
                                                                    $advertisment->expiry_date > date('Y-m-d H:i:s'))
                                                                <li>
                                                                    <a href="{{ route('office-advertisementEditRequest', isset($advertisment->id) ? $advertisment->id : -1) }}"
                                                                        class="btn">
                                                                        @if (Config::get('app.locale') == 'ar')
                                                                            طلب تعديل
                                                                        @elseif (Config::get('app.locale') == 'en')
                                                        ...
                                                        @if (isset($advertisment->status) && ($advertisment->status == 'Active' || $advertisment->status == 'Inactive'))
                                                            <li>
                                                                <a class="btn"
                                                                    href="{{ route('office-activeInactiveAdvertisement', isset($advertisment->id) ? $advertisment->id : -1) }}">
                                                        ...
                                                        <li>
                                                            <a class="btn"
                                                                href="{{ route('office-deleteAdvertisement', isset($advertisment->id) ? $advertisment->id : -1) }}">
                                                                @if (Config::get('app.locale') == 'ar')
                                                                    حذف
                                                                @elseif (Config::get('app.locale') == 'en')
                                                                    delete
