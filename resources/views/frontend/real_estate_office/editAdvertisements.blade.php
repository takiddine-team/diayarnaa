    ...
    <div class="innerPage">
        ...
        <div class="page_wrapper dashboard">
            <div class="bredCramb">
                ...
                <span class="enflip"> >> </span> <span>@lang('front.RePublishAd')</span>
            </div>
                    ...
                    <div class="row">
                        <div class="col-12 bShadow">
                            <form class="editUserForm" class="realStateFilter" id="createForm" style="text-align: initial"
                                action="{{ route('office-updateAdvertisementRequest', isset($ad->id) ? $ad->id : -1) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="diyarnaa_city_id" id="diyarnaa_city_id"
                                                ...
                                                <option>@lang('front.City')</option>
                                                @if (isset($user_cities) && count($user_cities) > 0)
                                                    @foreach ($user_cities as $city)
                                                        <option value="{{ $city->id }}"
                                                            @if (old('diyarnaa_city_id')) {{ old('diyarnaa_city_id') == $city->id ? 'selected' : null }}
                                                            @else
                                                                {{ $ad->diyarnaa_city_id == $city->id ? 'selected' : null }} @endif>
                                                            @if (Config::get('app.locale') == 'ar')
                                                                <span class="realState_Location">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" class="form-control" name="ad_reference"
                                            value="{{ isset($ad->ad_reference) ? $ad->ad_reference : null }}">
                                    </div>
