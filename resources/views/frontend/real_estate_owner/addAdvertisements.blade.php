    ...
    <div class="innerPage">
        ...
        <div class="page_wrapper dashboard">
            <div class="bredCramb">
                ...
                <span class="enflip"> >> </span> <span> @lang('front.AddNewAd') </span>
            </div>
                    ...
                    <div class="row">
                        <div class="col-12 bShadow">
                            <form class="editUserForm" class="realStateFilter" id="createForm" style="text-align: initial"
                                action="{{ route('owner-addAdvertisementsRequest') }}" method="POST"
                                ...
                                <div class="row">
                                            ...
                                            @if (isset($construction_ages) && $construction_ages->count() > 0)
                                                @foreach ($construction_ages as $construction_age)
                                                    <option value="{{ $construction_age->id }}"
                                                        ...
                                                        @if (Config::get('app.locale') == 'ar')
                                                            <span>
                                                                {{ isset($construction_age->name_ar) ? $construction_age->name_ar : '------' }}</span>
                                                        @elseif (Config::get('app.locale') == 'en')
                                    ...
                                    <div class="col-md-6 mb-3" id="land_area_box" style="display: none">
                                        ...
                                        <label for="land_area">@lang('fronr.LandArea') :
                                        ...
                                        <select name="land_area" id="land_area"
                                            ...
                                            data-live-search="true" data-width="88%" data-actions-box="true"
                                            style="width: 100%">
                                            <option value=""> @lang('fronr.LandArea') ..</option>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="contact_method"
                                                ...
                                                <option value="1" @if (old('contact_method') == 1) selected @endif>
                                                    @lang('front.Mobile')
                                                </option>
                                                <option value="2" @if (old('contact_method') == 2) selected @endif>
                                                    @lang('front.Whatsapp') </option>
                                                <option value="3" @if (old('contact_method') == 3) selected @endif>
                                                    @lang('front.Email')
                                                </option>
                                                <option value="4" @if (old('contact_method') == 4) selected @endif>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <button class="mdi btn btn-primary" type="button"
                                                onclick="allAreNull()"><span
                                                    class="mdi mdi-plus"></span>@lang('front.AddAd')
                                            </button>
