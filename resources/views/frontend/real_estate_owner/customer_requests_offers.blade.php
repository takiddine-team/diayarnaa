    ...
    <div class="innerPage">
        ...
        <div class="page_wrapper dashboard">
            <div class="bredCramb">
                ...
                <span class="enflip"> >> </span> <span> @lang('front.CustomerProposalRequests')</span>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="twoBtn">
                                    ...
                                    <div class="col-3 mb-3 askbtn">
                                        <a href="{{ route('owner-createCustomerRequestsOffer') }}">@lang('front.Add')</a>
                                    </div>
                                </div>
                                                ...
                                                @if ($offer->type == 'Request')
                                                    <tr>
                                                        ...
                                                        @elseif (Config::get('app.locale') == 'en')
                                                            <td>{{ isset($offer->target->name_en) ? $offer->target->name_en : '' }}
                                                            </td>
                                                        @endif
                                                        {{--  ////////////////////////////////////////////////////////////////  --}}
                                                        ...
                                                        @elseif (Config::get('app.locale') == 'en')
                                                            <td>{{ isset($offer->mainCategory->name_en) ? $offer->mainCategory->name_en : '' }}
                                                            </td>
                                                        @endif
                                                        ...
                                                        @elseif (Config::get('app.locale') == 'en')
                                                            <td>{{ isset($offer->diyarnaaCountry->name_en) ? $offer->diyarnaaCountry->name_en : '' }}
                                                            </td>
                                                        @endif
                                                        ...
                                                        @elseif (Config::get('app.locale') == 'en')
                                                            <td>{{ isset($offer->diyarnaaCity->name_en) ? $offer->diyarnaaCity->name_en : '' }}
                                                            </td>
                                                        @endif
                                                        ...
                                                        @elseif (Config::get('app.locale') == 'en')
                                                            <td>{{ isset($offer->diyarnaaRegion->name_en) ? $offer->diyarnaaRegion->name_en : '' }}
                                                            </td>
                                                        @endif
                                                        ...
                                                        <td>
                                                            <a target="_blank"
                                                                href="{{ route('owner-showCustomerRequestsOffer', [isset($offer->id) ? $offer->id : -1]) }}"
                                                                class="mb-1 btn btn-sm btn-primary">عرض</a>

                                                            <a href="{{ route('owner-destroyCustomerRequestOffer', [isset($offer->id) ? $offer->id : -1]) }}"
                                                                class="confirm mb-1 btn btn-sm btn-danger">حذف</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                            @endforeach
