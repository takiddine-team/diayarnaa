...
@section('content')
    ...
    <div class="innerPage">
        ...
        <section class="innerImage aboutUs">
            ...
            <div class="pageTitle">
                <h2> @lang('front.ChangeOwnerPersonalInformation') </h2>
            </div>
        </section>
        ...
        <div class="page_wrapper dashboard">
            {{--  <div class="bredCramb">
                ...
                >>
                @if (Config::get('app.locale') == 'ar')
                    <span> تغيير معلومات المالك العقاري</span>
                @elseif (Config::get('app.locale') == 'en')
            ...
            <div class="bredCramb">
                ...
                <span class="enflip"> >> </span> <span>@lang('front.ChangeOwnerPersonalInformation')</span>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 bShadow">
                            <form action="{{ route('owner-changeRealEstateOfficePassword') }}" method="POST"
                                class="editUserForm">
                                @csrf
                                ...
                                <div class="twoBtn">
                                    ...
                                    <div class="col-12 mb-3">
                                        <a href="{{ route('owner-userDashboard') }}"><input type="button" class="cancel"
                                                value="@lang('front.Cancel')"></a>
                                    </div>
                                </div>

                            </form>
                            <form action="{{ route('owner-changeRealEstateOfficeEmail') }}" class="editUserForm"
                                method="POST">
                                @csrf
                            ...
                            <form action="{{ route('owner-changeRealEstateOfficePhone') }}" class="editUserForm"
                                method="POST">
                                @csrf
                                    ...
                                    {{-- <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control-plus"
                                                    placeholder=" ********** ">
                                            </div>
                                        </div>
                                    </div> --}}
                                ...
                                <div class="twoBtn">
                                    ...
                                    {{-- Cancel --}}
                                    <div class="col-12 mb-3">
                                        <a href="{{ route('owner-userDashboard') }}"><input type="button"
