                                ...
                                <div class="bShadow  p-3">
                                    <div class="list-group" id="list-tab" role="tablist">
                                        ...
                                        <a class="list-group-item list-group-item-action" id="list-profile-list"
                                            ...
                                            @lang('front.Inbox')
                                            ( @if (isset($mails_not_read_count) && $mails_not_read_count > 0)
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        ...
                                                        <div class="col-12 mb-3 text-center">
                                                            ...
                                                            <label for="actualBtn" id="img" class="uploadImage">
                                                                ...
                                                                <span id="selectedBanner" for="actualBtn" id="img"
                                                                    class="uploadImage"
                                                                    style="float: left;
                                                            padding-bottom: 16px;
                                                            padding-top: 13px;">
                                                        ...
                                                        <textarea name="details" id="" rows="5" class="form-control h-auto">{{ old('details') ? old('details') : '' }}</textarea>
                                                    </div>
                                            ...
                                            <ul class="allMail">
                                                @if (isset(auth()->guard('user')->user()->receivedMails) &&
                                                    ...
                                                    @foreach (auth()->guard('user')->user()->receivedMails as $mail)
                                                        <li @if ($mail->is_read == 'No') class="unread" @endif>
                                                            ...
                                                            <a href="{{ route('messageDetails', isset($mail->id) ? $mail->id : -1) }}"
                                                                ...
                                                                <div class="textInfo">
                                                                    ...
                                                                    @if (isset($mail->email_type) && $mail->email_type == 'Accept with Conditions')
                                                                        <h6>
                                                                            @if (Config::get('app.locale') == 'ar')
                                                                                قبول بشرط تعديل الاعلان
