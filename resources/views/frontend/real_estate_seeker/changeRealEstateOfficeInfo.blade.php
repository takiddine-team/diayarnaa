...
@section('content')
    ...
    <div class="innerPage">
        ...
        <div class="page_wrapper dashboard">
            ...
            >>>
            @if (Config::get('app.locale') == 'ar')
            <span> تغيير معلومات الدخول</span>
            @elseif (Config::get('app.locale') == 'en')
            Change Login Info
            </span>
            @endif
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 bShadow">
                            <form action="{{ route('seeker-changeRealEstateOfficePassword') }}" method="POST"
                                class="editUserForm">
                                @csrf
                                ...
                                <div class="twoBtn">
                                    ...
                                    <div class="col-12 mb-3">
                                        <a href="{{ route('seeker-userDashboard') }}"><input type="button" class="cancel"
                                                value="@lang('front.Cancel')"></a>
                                    </div>
                                </div>

                            </form>
                            <form action="{{ route('seeker-changeRealEstateOfficeEmail') }}" class="editUserForm"
                                method="POST">
                                @csrf
                            ...
                            <form action="{{ route('seeker-changeRealEstateOfficePhone') }}" class="editUserForm"
                                method="POST">
                                @csrf
                                ...
                                <div class="twoBtn">
                                    ...
                                    {{-- Cancel --}}
                                    <div class="col-12 mb-3">
                                        <a href="{{ route('seeker-userDashboard') }}"><input type="button"
